...
router.route('/')
    ...
    .post(authMiddleware_1.protect, subscriptionMiddleware_1.checkInvoiceQuota, invoiceController_1.createInvoice);
router.route('/:id')
...
router.route('/:id/generate-teif')
    .post(authMiddleware_1.protect, invoiceController_1.generateInvoiceTeifController);
router.route('/:id/sign-teif')
    .post(authMiddleware_1.protect, invoiceController_1.signInvoiceTeifController);
