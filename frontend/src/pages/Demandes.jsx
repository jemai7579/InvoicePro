...
import {
  ...
  Loader, FileText, ChevronDown, PlusCircle, MinusCircle,
  AlertCircle, Zap, ExternalLink, Lightbulb, Search
} from 'lucide-react';
                ...
                <div key={i} className="flex gap-4 items-center bg-slate-50/50 p-2 rounded-2xl ring-1 ring-slate-100 group transition-all hover:ring-indigo-100 hover:bg-white hover:shadow-xl hover:shadow-indigo-50/20">
                  <div className="flex-1 px-4">
                    <input
                      ...
                      placeholder={t('demandes.form.desc_placeholder')}
                  ...
                  <div className="w-20 px-2 border-x border-slate-100">
                    <input
                      type="number"
                      value={ln.quantity}
                      onChange={(e) => setLine(i, 'quantity', parseFloat(e.target.value))}
                  ...
                  <div className="w-32 px-4">
                    <input
                      type="number"
                      value={ln.unitPrice}
                      onChange={(e) => setLine(i, 'unitPrice', parseFloat(e.target.value))}
  ...
  return (
    <div className="pb-12 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
        ...
        <Button onClick={() => setShowModal(true)} className="shadow-lg shadow-indigo-100 group w-full md:w-auto">
